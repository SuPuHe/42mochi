class Character {
    ...
    async loadAssets() {
        try {
            ...
            let jsonFile = '/public/js/sprites/mochi-green-idlehappyhungry.json';
            let pngFile = '/public/images/sprites/mochi-green-idlehappyhungry.png';

            if (this.spriteType === 'red') {
                jsonFile = '/public/js/sprites/mochi-red-idlehappyhungry.json';
                pngFile = '/public/images/sprites/mochi-red-idlehappyhungry.png';
            } else if (this.spriteType === 'purple') {
                jsonFile = '/public/js/sprites/mochi-purple-idlehappyhungry.json';
                pngFile = '/public/images/sprites/mochi-purple-idlehappyhungry.png';
            }
